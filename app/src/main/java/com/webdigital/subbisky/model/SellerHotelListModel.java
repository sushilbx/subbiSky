...
public class SellerHotelListModel {
    private Boolean success;
    private Integer statusCode;
    private String message;
    private List<SellerHotel> hotels;
    ...
    public List<SellerHotel> getHotels() {
        return hotels;
    }

    public void setHotels(List<SellerHotel> hotels) {
        this.hotels = hotels;
    }

    public class SellerHotel {
        private Integer id,seller_id;
        private String name,available_rooms,description,checkin_time,checkout_time,price,
        ...
        private List<Amenity_idList> amenity_id;
        ...
        public List<Amenity_idList> getAmenity_id() {
            return amenity_id;
        }

        public void setAmenity_id(List<Amenity_idList> amenity_id) {
            this.amenity_id = amenity_id;
        }

        public class Amenity_idList {
            private Integer id;
