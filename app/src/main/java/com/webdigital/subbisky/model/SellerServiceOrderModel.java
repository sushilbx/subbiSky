...
public class SellerServiceOrderModel {
    private String message;
    private Boolean success;
    private Integer statusCode;
    private List<ServiceOrderList> order;
    ...
    public List<ServiceOrderList> getOrder() {
        return order;
    }

    public void setOrder(List<ServiceOrderList> order) {
        this.order = order;
    }
