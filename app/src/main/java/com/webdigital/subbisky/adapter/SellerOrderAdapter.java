...
public class SellerOrderAdapter extends RecyclerView.Adapter<SellerOrderAdapter.sellerOrderAdapterHolder> {
    private List<SellerServiceOrderModel.ServiceOrderList> serviceOrderList = new ArrayList<>();
    private Context context;

    public SellerOrderAdapter(List<SellerServiceOrderModel.ServiceOrderList> serviceOrderList, Context context) {
    ...
    @NonNull
    @Override
    public SellerOrderAdapter.sellerOrderAdapterHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_design_service_order_list, null);
        return new SellerOrderAdapter.sellerOrderAdapterHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull SellerOrderAdapter.sellerOrderAdapterHolder holder, @SuppressLint("RecyclerView") int position) {
