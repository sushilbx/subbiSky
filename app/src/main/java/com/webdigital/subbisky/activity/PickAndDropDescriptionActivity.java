...
public class PickAndDropDescriptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pick_and_drop_description);
    ...
    public void renewItems(View view) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i % 2 == 0) {
                sliderItem.setImageUrl(R.drawable.pickdrop);
                //sliderItem.setImageUrl("https://images.pexels.com/photos/929778/pexels-photo-929778.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260");
            } else {
                sliderItem.setImageUrl(R.drawable.pickdrop2);
    ...
    public void serviceDetails(View v) {
        Intent intent=new Intent(PickAndDropDescriptionActivity.this,PickDropGoodsActivity.class);
        startActivity(intent);
    }
}
